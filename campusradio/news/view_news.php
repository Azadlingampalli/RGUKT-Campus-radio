...
$sql = "SELECT news.*, students.college_id
        FROM news
        JOIN students ON news.posted_by = students.id
    ...
    <div class="container-fluid d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex align-items-center">
            ...
            <span class="navbar-brand mb-0 h1">
                RGUKT-B Campus Radio/View News
            </span>
        </div>
...
<div class="d-flex gap-2">
    <a href="../student/post_news.php" class="btn btn-dark">➕ Post News</a>
...
<span class="badge bg-primary"><?php echo $row['category']; ?></span>
 | <b>Posted By:</b> <?php echo $row['college_id']; ?>
...
<?php
$news_id=$row['news_id'];
$media=mysqli_query($conn,"SELECT * FROM news_media WHERE news_id='$news_id'");
